...
'''
        ...
        self.mipmapVertexShaderModule = device.create_shader_module(code = mipmap_vertex_source)

        self.mipmapFragmentShaderModule = device.create_shader_module(code = mipmap_fragment_source)
    ...
    def generate_mipmaps( self, texture_gpu:'wgpu.GPUTexture', format, mip_level_count, base_array_layer = 0 ):
