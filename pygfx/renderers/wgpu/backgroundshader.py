    ...
    def code_vertex(self):
        ...
        fn vs_main(in: VertexInput) -> Varyings {
            ...
            $$ if texture_dim == "cube"
                ...
                let d = wpos1.xyz - wpos2.xyz;  // view direction in world space, also the cube map texcoord.
                ...
                // Since pygfx uses a right-handed coordinate system, we need to flip the x coordinate when sampling from the cube map.
                varyings.texcoord = vec3<f32>(-d.x, d.y, d.z);
            $$ else
                // Store positions and the view direction in the world
