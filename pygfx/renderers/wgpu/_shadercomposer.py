        ...
        struct {structname} {{
            ...
            for fieldname, (dtype, offset) in dtype_struct.fields.items():
                ...
                if shape == () or shape == (1,):
                    ...
                    if n < 2 or n > 4:
                        raise TypeError(
                            f"Type {dtype} looks like an unsupported vec{n}."
                        )
                ...
                if not wgsl_type:
                    ...
                    raise TypeError(
                        f"Cannot establish alignment of wgsl type: {wgsl_type}"
                    )
...
class WorldObjectShader(BaseShader):
    ...
    def common_functions(self):
        ...
        # Maybe should use a constant instead of a function?
        is_orthographic_code = """
