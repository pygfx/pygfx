...
def vertex_shader(
    ...
    in_texcoord: (python_shader.RES_INPUT, 1, vec3),
    out_pos: (python_shader.RES_OUTPUT, "Position", vec4),
    v_texcoord: (python_shader.RES_OUTPUT, 0, vec3),
...
def fragment_shader_textured_gray(
    v_texcoord: (python_shader.RES_INPUT, 0, vec3),
    u_mesh: (python_shader.RES_UNIFORM, (1, 0), MeshVolumeSliceMaterial.uniform_type),
    s_sam: (python_shader.RES_SAMPLER, (1, 1), ""),
    t_tex: (python_shader.RES_TEXTURE, (1, 2), "3d i32"),
