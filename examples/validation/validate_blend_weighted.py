...
plane1 = gfx.Mesh(
    geometry, gfx.MeshBasicMaterial(alpha_mode="weighted", color="r", opacity=0.3)
)
plane2 = gfx.Mesh(
    geometry, gfx.MeshBasicMaterial(alpha_mode="weighted", color="g", opacity=0.5)
)
plane3 = gfx.Mesh(
    geometry, gfx.MeshBasicMaterial(alpha_mode="weighted", color="b", opacity=0.7)
)
