...
plane1 = gfx.Mesh(
    geometry, gfx.MeshBasicMaterial(blending="weighted", color="red", opacity=0.3)
)
plane2 = gfx.Mesh(
    geometry, gfx.MeshBasicMaterial(blending="weighted", color="green", opacity=0.5)
)
plane3 = gfx.Mesh(
    geometry, gfx.MeshBasicMaterial(blending="weighted", color="blue", opacity=0.7)
)
