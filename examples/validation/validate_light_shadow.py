...
cube.transform.rotation = la.quaternion_make_from_euler_angles(
...
cube2.transform.rotation = la.quaternion_make_from_euler_angles(
    (np.pi / 4, np.pi / 4), order="XY"
)
cube2.transform.position = (0, -150, 0)
...
cube3.transform.position = (0, -250, 0)
...
box.transform.rotation = la.quaternion_make_from_euler_angles(-np.pi / 2, order="X")
