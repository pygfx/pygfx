...
plane1.transform.position = (-0.51, -0.51, -(near + 0.01))  # in range
plane2.transform.position = (+0.51, -0.51, -(near - 0.01))  # out range
plane3.transform.position = (-0.51, +0.51, -(far - 0.01))  # in range
plane4.transform.position = (+0.51, +0.51, -(far + 0.01))  # out range
