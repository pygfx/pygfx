"""
physical output colorspace
==========================

Show different colorspace textures in physical colorspace.

* The top image shows linear data in physical colorspace, looks non-linear.
* The 2nd shows linear data in srgb colorspace, interpolated in srgb (srgb-to-linear happens in shader), looks linear.
* The 3d shows linear data in srgb colorspace, interpolated in linear space (srgb-to-linear is automatic).
...
renderer = gfx.renderers.WgpuRenderer(
    RenderCanvas(size=(600, 600)), output_colorspace="physical"
)
