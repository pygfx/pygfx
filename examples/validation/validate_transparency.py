...
plane1.transform.rotation = la.quaternion_make_from_axis_angle((1, 0, 0), 1.571)
plane2.transform.rotation = la.quaternion_make_from_axis_angle((0, 1, 0), 1.571)
plane3.transform.rotation = la.quaternion_make_from_axis_angle((0, 0, 1), 1.571)

t = gfx.Text(
    gfx.TextGeometry(renderer.blend_mode, screen_space=True, font_size=20),
    gfx.TextMaterial(),
)
t.transform.position = (0, 40, 0)
...
camera.transform.position = (30, 40, 50)
