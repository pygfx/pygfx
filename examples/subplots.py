...
a feature necessary to implement subplots.
"""
...
def animate():
    ...
    renderer.render(scene1, camera1, clear=True, region=(0, 0, size[0] / 2, size[1]))
    renderer.render(
        scene2, camera2, clear=False, region=(size[0] / 2, 0, size[0] / 2, size[1])
    )

    # renderer1.submit() -> write to final buffer and apply any post processing steps
    # This is also where we could auto-clear
