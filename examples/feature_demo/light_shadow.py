...
cube.local.rotation = la.quaternion_make_from_euler_angles((math.pi / 6, math.pi / 6), order="XY")
...
cube2.local.rotation = la.quaternion_make_from_euler_angles((math.pi / 4, math.pi / 4), order="XY")
