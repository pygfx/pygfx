...
cylinders = [
    ((0, 0, -32.5), (0, 0.65, 0, 1), gfx.CylinderGeometry(20, 12, radial_segments=16, height=25)),
    ((0, 0, 25), (1, 1, 1, 1), gfx.CylinderGeometry(10, 10, height=25)),
    ((-50, 0, 0), (0.35, 0, 0, 1), gfx.CylinderGeometry(20, 12, radial_segments=3, height_segments=4, height=10, open_ended=True)),
